...
const emaildangky = document.getElementById('id-dangky-email');
const matkhaudangky = document.getElementById('id-dangky-matkhau');
const matkhau2dangky = document.getElementById('id-dangky-nhaplaimatkhau');
const tenKHdangky = document.getElementById('id-dangky-tenkhachhang');
const diaChidangky = document.getElementById('id-dangky-diachi');
const sdtdangky = document.getElementById('id-dangky-sdt');
const ngaysinhdangky = document.getElementById('id-dangky-ngaysinh');
