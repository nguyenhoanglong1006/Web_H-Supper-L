...
<title>H-supper-L (Đăng kí)</title>
<link
					...
					<div class="row">
						...
						<div class="col-8">
							...
							<form:form
								...
								modelAttribute="hlUser" class="form-horizontal">
								<label for="id-dangky-email">Email:</label>
								<input name="email" type="text"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập email" id="id-dangky-email" />
								<div class=" invalid-feedback text-danger">* Email không
									được trống và phải có dạng xxx@gmail.com</div>

								<label for="id-dangky-matkhau">Mật khẩu:</label>
								<input name="trangThai" type="password"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập mật khẩu" id="id-dangky-matkhau" />
								<div class=" invalid-feedback text-danger">* Mật khẩu
									không được trống</div>

								<label for="id-dangky-nhaplaimatkhau">Nhập lại mật khẩu:</label>
								<input type="password"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập lại mật khẩu" id="id-dangky-nhaplaimatkhau" />
								<div class=" invalid-feedback text-danger">*Không được
									trống và phải trùng với mật khẩu</div>



								<label for="id-dangky-tenkhachhang">Tên khách hàng:</label>
								<input type="text" name="tenKH"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập tên khách hàng" id="id-dangky-tenkhachhang" />
								<div class=" invalid-feedback text-danger">* Tên không
									được trống và chỉ nhập chữ</div>

								<label for="id-dangky-sdt">Số điện thoại:</label>
								<input type="text" name="sdt"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập số điện thoại" id="id-dangky-sdt" />
								<div class=" invalid-feedback text-danger">* Số điện thoại
									không được để trống và chứa 10 số bắt đầu bằng số 0</div>

								<label>Giới tính:</label>
								<input type="radio" class="hl-bd-radius mt-1" id="id-dangky-nam"
									name="gioiTinh" value="Nam" checked />
								<label for="id-dangky-nam" class="me-5">Nam</label>

								<input type="radio" class="hl-bd-radius mt-1 ms-3"
									id="id-dangky-nu" name="gioiTinh" value="Nữ"/>
								<label for="id-dangky-nu">Nữ</label>

								<div>
									<label for="id-dangky-ngaysinh" class="mt-3 mb-1">Ngày
										sinh:</label> <input type="date" name=ngaySinh
										class="form-control hl-bd-radius-text mt-1 mb-4"
										placeholder="Nhập ngày sinh" id="id-dangky-ngaysinh" />
									<div class=" invalid-feedback text-danger">* Ngày sinh
										chưa chọn</div>
								</div>

								<label for="id-dangky-diachi">Địa chỉ:</label>
								<input type="text" name="diaChi"
									class="form-control hl-bd-radius-text mt-1 mb-4"
									placeholder="Nhập địa chỉ" id="id-dangky-diachi" />

								<a href="${pageContext.request.contextPath}/login">
									<button id="id-btn-dangky" type="submit"
										class="btn hl-btn hvr-grow hvr-shutter-out-horizontal form-control">
										Đăng ký</button>
									<div class=" invalid-feedback text-danger">* Không được
										để trống</div>
								</a>
